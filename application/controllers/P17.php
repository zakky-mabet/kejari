...
class P17 extends Admin_panel {
	...
	public function __construct()
	{
		...
		$this->breadcrumbs->unshift(1, 'Surat Perintah Penujukan Jaksa Penuntuan Umum', "p17");
	...
	{
		$this->page_title->push("P-17", "Data Surat Perintah Penujukan Jaksa Penuntuan Umum");
		...
		$this->data['p16'] = $this->mp17->get_all($this->per_page, $this->page, 'result');
