...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
                    ...
                    <input type="text"  class="form-control" autofocus name="nomor_print" value="<?php echo  set_value('nomor_print') ?>">
                ...
                <div class="form-group">
                    <label for="dasar" class="control-label">DASAR : <strong class="text-red">*</strong></label>
                   	<textarea name="dasar" rows="8" class="form-control textarea"><?php echo  set_value('dasar') ?></textarea>
                ...
                <div class="form-group">
                    <label for="pertimbangan" class="control-label">PERTIMBANGAN : <strong class="text-red">*</strong></label>
                   	<textarea name="pertimbangan" rows="8" class="form-control textarea"><?php  echo set_value('pertimbangan') ?></textarea>
                ...
                <div class="form-group">
                    <label for="untuk" class="control-label">UNTUK : <strong class="text-red">*</strong></label>
                   	<textarea name="untuk" rows="8" class="form-control textarea"><?php  echo set_value('untuk') ?></textarea>
