			...
			<div class="box-body" style="margin-top: 10px;">
				<table class="table" >
					...
					<tr>
						...
						<td class="small"><?php echo $this->mp17->get_p17($param)->nomor ?></td>
					</tr>
					<tr>
						<th class="small">ASAL</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->asal ?></td>
					</tr>
					<tr>
						<th class="small">DESKRIPSI</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->deskripsi ?></td>
					</tr>
					<tr>
						<th class="small">TANGGAL DIBUAT</th>
						<td class="small"><?php echo date_id($this->mp17->get_p17($param)->tanggal_masuk) ?></td>
					</tr>
					<tr>
						<th class="small">TANGGAL DIUBAH</th>
						<td class="small">
							<?php if ($this->mp17->get_p17($param)->tanggal_update_spdp == NULL): ?>
								<i>Belum ada perubahan</i>
							<?php else: ?>
								<?php echo date_id($this->mp17->get_p17($param)->tanggal_update_spdp) ?>
							<?php endif ?>
						</td>
					</tr>
					<tr>
						<th class="small">PENJABAT PEMBUAT</th>
						<td class="small"><?php echo $this->mp17->get_by_id($this->mp17->get_p17($param)->user_id)->nip.' - '.$this->mp17->get_by_id($this->mp17->get_p17($param)->user_id)->first_name.' '.$this->mp17->get_by_id($this->mp17->get_p17($param)->user_id)->last_name ?> </td>
					</tr>
			...
			<div class="box-body" style="margin-top: 10px;">
				<table class="table" >
					...
					<tr>
						...
						<td class="small"><?php echo $this->mp17->get_p17($param)->nomor_print ?></td>
					</tr>
					<tr>
						<th class="small">DASAR</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->dasar ?></td>
					</tr>
					<tr>
						<th class="small">PERTIMBANGAN</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->pertimbangan ?></td>
					</tr>
					<tr>
						<th class="small">UNTUK</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->untuk ?></td>
					</tr>
					<tr>
						<th class="small">DASAR</th>
						<td class="small"><?php echo $this->mp17->get_p17($param)->dasar ?></td>
					...
					<tr>
						<th class="small">TANGGAL DIBUAT</th>
						<td class="small"><?php echo date_id($this->mp17->get_p17($param)->tanggal_create) ?></td>
					</tr>
					<tr>
						<th class="small">TANGGAL DIUBAH</th>
						<td class="small">
							<?php if ($this->mp17->get_p17($param)->tanggal_update_p16 == NULL): ?>
								<i>Belum ada perubahan</i>
							<?php else: ?>
								<?php echo date_id($this->mp17->get_p17($param)->tanggal_update_p16) ?>
							<?php endif ?>
						</td>
					</tr>
					<tr>
						<th class="small">PENJABAT PEMBUAT</th>
						<td class="small"><?php echo $this->mp17->get_by_id($this->mp17->get_p17($param)->id_user_p16)->nip.' - '.$this->mp17->get_by_id($this->mp17->get_p17($param)->id_user_p16)->first_name.' '.$this->mp17->get_by_id($this->mp17->get_p17($param)->id_user_p16)->last_name ?> </td>
					</tr>
