...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="date" id="datepicker" class="form-control" value="<?php echo $gaji->tmt ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="no_sk" class="form-control" value="<?php echo $gaji->no_sk ?>">
