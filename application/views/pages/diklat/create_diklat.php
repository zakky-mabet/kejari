			...
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="tingkat" class="form-control">
							...
							<option value="Nasional" <?php if(set_value('tingkat')=='Nasional') echo "selected"; ?>>Nasional</option>
							<option value="Internasional" <?php if(set_value('tingkat')=='Internasional') echo "selected"; ?>>Internasional</option>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
					  	<div class="input-group">
					    	...
					    	<input type="text" class="form-control" name="tgl_mulai" id="datepicker" value="<?php echo set_value('tgl_mulai'); ?>" placeholder="Ex : 1980-12-31">
					  	</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
					  	<div class="input-group">
					    	<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					    	<input type="text" class="form-control" name="tgl_selesai" id="datepicker" value="<?php echo set_value('tgl_selesai'); ?>" placeholder="Ex : 1980-12-31">
					  	</div>
