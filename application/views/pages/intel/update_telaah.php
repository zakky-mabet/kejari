		...
		<div class="box box-primary">
			...
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
                	...
                	<textarea name="uraian_permasalahan" rows="8"  placeholder="Tulis Uraian Permasalahan di sini." class="textarea form-control"><?php echo $get->uraian_permasalahan ?></textarea>
