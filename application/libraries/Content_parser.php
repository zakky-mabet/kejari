...
class Content_parser
{
	...
	{
		return $this->related_news_right($post, $limit);
	}

	
	public function related_news_right($post = 0, $limit = 3)
	{
		...
		$content  = '<div class="col-xs-6 box-sidebar incontent bg-gray pull-right">';
	...
	public function related_news_left($post = 0, $limit = 3)
	{
		$inputTags = array_map(function ($object) { 
				return $object->tag_id; 
			}, 
		...
		$content  = '<div class="col-xs-6 box-sidebar incontent bg-gray pull-left">';
		$content .=	'<div class="box-category-1"><h3 class="sidebar-heading">Baca Juga</h3>';
		/**
		 * Get Similar Post by Tag
		 *
